...
class RestEndpoint {
	...
	public function can_access(): bool {
		...
		return apply_filters( 'foldspy_allow_rest', $allowed );
	}
	...
	public function handle_request( WP_REST_Request $request ) {
		...
		if ( ! $success ) {
			...
			return new WP_Error( 'foldspy_db_error', 'Could not store visit', array( 'status' => 500 ) );
		}

		$this->logger->log(
			'Visit logged successfully.'
		);
		return new WP_REST_Response( array( 'message' => 'Visit recorded' ), 200 );
	}
}
