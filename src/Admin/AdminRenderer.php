...
class AdminRenderer {
                        ...
                        <?php else: ?>
                            <?php foreach ($logs as $log): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo esc_url( admin_url( 'admin.php?page=foldspy-logs&view_log=' . $log['id'] ) ); ?>">
                                            View Details
                                        </a>
                                    </td>
    ...
    public function render_pagination(int $current_page, int $total_pages): void {
        ...
        <div class="tablenav bottom">
            <div class="tablenav-pages">
                <span class="displaying-num"><?php echo sprintf(_n('%s item', '%s items', $total_pages), number_format_i18n($total_pages)); ?></span>
                <span class="pagination-links">
                    <?php if ($current_page > 1): ?>
                        <a class="prev-page button" href="<?php echo esc_url(add_query_arg('paged', $current_page - 1, $base_url)); ?>" aria-label="Previous page">&laquo; Prev</a>
                    <?php else: ?>
                    ...
                    <?php if ($current_page < $total_pages): ?>
                        <a class="next-page button" href="<?php echo esc_url(add_query_arg('paged', $current_page + 1, $base_url)); ?>" aria-label="Next page">Next &raquo;</a>
                    <?php else: ?>
     ...
     * 
     * @param ?array $log The log entry to render, or null if the log is not found.
     */
